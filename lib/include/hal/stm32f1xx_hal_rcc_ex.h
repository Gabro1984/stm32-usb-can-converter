...
#    define IS_RCC_PLL_MUL(__MUL__)                                                                \
        (((__MUL__) == RCC_PLL_MUL4) || ((__MUL__) == RCC_PLL_MUL5) || ((__MUL__) == RCC_PLL_MUL6) \
         || ((__MUL__) == RCC_PLL_MUL7) || ((__MUL__) == RCC_PLL_MUL8)                             \
         || ((__MUL__) == RCC_PLL_MUL9) || ((__MUL__) == RCC_PLL_MUL6_5))
...
#    define IS_RCC_MCO1SOURCE(__SOURCE__)                                                        \
        (((__SOURCE__) == RCC_MCO1SOURCE_SYSCLK) || ((__SOURCE__) == RCC_MCO1SOURCE_HSI)         \
         ...
         || ((__SOURCE__) == RCC_MCO1SOURCE_EXT_HSE) || ((__SOURCE__) == RCC_MCO1SOURCE_NOCLOCK))

#else
#    define IS_RCC_PLL_MUL(__MUL__)                                                                \
        (((__MUL__) == RCC_PLL_MUL2) || ((__MUL__) == RCC_PLL_MUL3) || ((__MUL__) == RCC_PLL_MUL4) \
         || ((__MUL__) == RCC_PLL_MUL5) || ((__MUL__) == RCC_PLL_MUL6)                             \
         || ((__MUL__) == RCC_PLL_MUL7) || ((__MUL__) == RCC_PLL_MUL8)                             \
         || ((__MUL__) == RCC_PLL_MUL9) || ((__MUL__) == RCC_PLL_MUL10)                            \
